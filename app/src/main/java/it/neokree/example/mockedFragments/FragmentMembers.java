...
public class FragmentMembers extends Fragment implements  View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater,@Nullable ViewGroup container,@Nullable Bundle savedInstanceState) {
        ...
        // SearchManager searchManager = (SearchManager) v.getSystemService(Context.SEARCH_SERVICE);
    ...
    class Memberlist1 extends AsyncTask<String, Void, String> {
        @Override
   ...
   /* public ExpandListAdapter()
    {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            if (convertView == null) {
                ...
                holder.relativechild = (RelativeLayout) convertView.findViewById(R.id.linearSecond);
       ...
       /* ArrayList<Child> chList = groups.get(groupPosition).getItems();
        ...
        public void filterdata(String query) {
            ...
            if (query.isEmpty()) {
                ...
                //groups.size();
                Log.v("ExpandlistAdapter", String.valueOf(groups.size()));
                ExpAdapter2 = new ExpandListAdapter(getActivity(), groups);
                ////ExpandList2 = (ExpandableListView) v.findViewById(R.id.exp_list);
               ...
               // ExpAdapter2.notifyDataSetChanged();
                ...
                if (newList.size() > 0) {
                    ...
                    ExpAdapter1 = new ExpandListAdapter(getActivity(), newList);
                   // ExpandList1 = (ExpandableListView) v.findViewById(R.id.exp_list);
